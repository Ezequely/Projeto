...
@NamedQueries({
    ...
    @NamedQuery(name = "AlunoTurma.findByCodTurma", query = "SELECT a FROM AlunoTurma a WHERE a.alunoTurmaPK.codTurma = :codTurma"),
...
public class AlunoTurma implements Serializable {
    ...
    public AlunoTurma(String codTurma, String matriculaAluno) {
        this.alunoTurmaPK = new AlunoTurmaPK(codTurma, matriculaAluno);
    }
